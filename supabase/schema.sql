...
-- ============================================
-- HOROSCOPE CONFIGURATION SYSTEM
...
DROP POLICY IF EXISTS "Public can view active rulesets" ON public.rulesets;
DROP POLICY IF EXISTS "Public can view active styles" ON public.styles;
DROP POLICY IF EXISTS "Public can view segments" ON public.segments;
DROP POLICY IF EXISTS "Public can view active rules" ON public.rules;
DROP POLICY IF EXISTS "Public can view active themes" ON public.themes;
DROP POLICY IF EXISTS "Public can view theme rules" ON public.theme_rules;
