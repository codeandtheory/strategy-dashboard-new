-- Add all profile fields to profiles table
-- Run this in your Supabase SQL Editor
-- This script adds: start_date, bio, location, website, and pronouns
...
WHERE table_schema = 'public' 
  AND table_name = 'profiles'
  AND column_name IN ('start_date', 'bio', 'location', 'website', 'pronouns')
