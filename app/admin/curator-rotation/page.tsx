...
export default function CuratorRotationPage() {
  ...
  return (
    <div className={`${getBgClass()} ${mode === 'code' ? 'font-mono' : 'font-[family-name:var(--font-raleway)]'}`}>
      <div className="mb-8">
        <h1 className={`text-4xl font-black uppercase ${getTextClass()} mb-2`}>Curator Rotation</h1>
        <p className={`${getTextClass()}/70 font-normal`}>Manage weekly curator responsibilities and rotation schedule.</p>
      </div>
